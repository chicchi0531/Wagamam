...
namespace ProjectWitch.Extention
{
    ...
    public static class MathEx
    {
        ...
        //0以上の値に丸めるメソッド greater than zero
        public static float GTZ(float source)
        {
            return Math.Max(0.0f, source);
        }
        public static int GTZ(int source)
        {
            return Math.Max(0, source);
        }

        //1以上の値に丸めるメソッド greater than one
        public static float GTO(float source)
        {
            return Math.Max(1.0f, source);
        }
        public static int GTO(int source)
        {
            return Math.Max(1, source);
        }
    }
}